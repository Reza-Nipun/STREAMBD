<!--    Video Player Asset Links Start-->
            ...
            <div class="row">
                <div class="col-md-12" id="description_container">
                    ...
                    <div style="background-color: white; font-size: 18px;">
                        <?php echo $res_info[0]['description']?>
                    </div>
                </div>
            </div>
        <?php } ?>
                ...
                <div class="row ipad-width">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="flex-wrap-movielist">
                            ...
                            <div class="movie-item-style-2 movie-item-style-1" onclick="playVideoNew(<?php echo $ch['id']?>, <?php echo $ch['cat_id']?>, <?php echo $ch['sub_cat_id']?>)">
                                <img src="<?php echo base_url()?>/uploads/images/<?php echo $ch['image']?>" alt="">
                                <div class="hvr-inner">
                                    <span onclick="playVideoNew(<?php echo $ch['id']?>, <?php echo $ch['cat_id']?>, <?php echo $ch['sub_cat_id']?>)"> WATCH NOW <i class="ion-android-arrow-dropright"></i> </span>
                                </div>
                            </div>
...
<!--                                <h4 class="sb-title">Search for Channel</h4>-->
...
<script type="text/javascript">
    ...
    function playVideo(url, download_url, description, player_type, file_type) {
        ...
        if(url != ''){
            ...
            if(player_type == 2){
                if(file_type == 1){
                    $("#player_container").append('<div class="video-responsive"><video id="my-video" class="video-js" controls preload="auto" width="853" height="480" poster="MY_VIDEO_POSTER.jpg" data-setup="{}" ><source src="'+url+'" type="application/x-mpegURL" /><p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that</p></video></div>');
                }
