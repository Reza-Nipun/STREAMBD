                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="sidebar">
                                <div class="searh-form">
                                    ...
                                    <h4 class="sb-title">New Request?</h4>
                                        ...
                                        <div class="form-style-1">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-it">
                                                    <label>Title</label>
                                                    <div class="group-ip">
                                                        <input type="text" placeholder="Title" name="title" id="title" required="required" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 form-it">
                                                    <label>Description</label>
                                                    <div class="group-ip">
                                                        <textarea name="description" id="description" placeholder="Description..." id="channel_keyword" required="required"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 ">
